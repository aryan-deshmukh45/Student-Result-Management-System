...
class Register:
    def __init__(self, root):
        ...
        left_frame.place(x=80, y=100, width=400, height=500)
        ...
        lbl_left = Label(left_frame, image=self.left, bd=0)
        lbl_left.place(x=0, y=0, width=400, height=500)
        
        # ===== INVISIBLE BUTTON ON IMAGE TEXT =====
        btn_signin = Button(
            lbl_left,
            text="Sign In",
        ...
        btn_signin.place(
            x=100,   # horizontal position of "Sign In" text in image
            y=315,   # vertical position of "Sign In" text
            width=200,
            height=50
        )
