...
class CourseClass:
    def __init__(self, root):
        ...
        #===Entry Fields====
        self.txt_courseName=Entry(self.root,textvariable=self.var_courese,font=("goudy old style",15,"bold"),bg="lightyellow")
        ...
        btn_search=Button(self.root,text='Search',font=("goudy old style",15,'bold'),bg='#2196f3',fg='white',cursor='hand2').place(x=1070,y=60,width=120,height=28)
        #=====content====
